...
import { Cpu, Wifi, Radio, Home as HomeIcon, GitBranch, Thermometer, Bug, Wrench, Network, Zap, Rocket, GraduationCap } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="relative min-h-[70vh] lg:min-h-screen flex items-center justify-center pt-20 lg:pt-24 overflow-hidden pillar-gold-overlay grid-pattern-animated"
        ...
        <div className="section-container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal distance={15}>
              <div className="relative aspect-square max-w-[220px] sm:max-w-md mx-auto animate-float-subtle">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2 sm:gap-3 max-w-xs mx-auto">
                  {[
                    ...
                    <ScrollReveal key={stat.label} delay={0.6 + index * 0.1} distance={15}>
                      <div className="text-center p-3 rounded-xl bg-bg-elevated/50 border border-border/30">
                        <stat.icon className="w-4 h-4 text-accent-gold mx-auto mb-1" aria-hidden="true" />
                        <div className="font-heading font-bold text-heading-sm text-text-primary gradient-text-gold">
                          {stat.value}
                        </div>
      ...
      {/* 2. What's Stopping Your Project? */}
      <section id="problems" className="relative py-10 lg:py-16 overflow-hidden" aria-labelledby="problems-title">
        <div className="absolute inset-0" aria-hidden="true" />
        <div className="section-container relative z-10">
          <ScrollReveal distance={30} className="text-center max-w-3xl mx-auto mb-8 md:mb-10 relative">
            ...
            <h2 id="problems-title" className="font-heading font-bold text-display-md text-text-primary mb-3 gradient-text">
          ...
          <ScrollReveal distance={30} delay={0.1}>
            <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                return (
                  <StaggerItem key={card.title} delay={index * 0.05}>
                    ...
                    >
                      ...
                      >
                        <div className={`w-12 h-12 rounded-2xl bg-accent-${card.pillarColor}/10 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}>
                          <Icon className={`w-6 h-6 text-accent-${card.pillarColor}`} aria-hidden="true" />
                        </div>
                        <h3 className="font-heading font-bold text-heading-md text-text-primary mb-2">
                          {card.title}
                        </h3>
                        <p className="text-body text-text-secondary mb-4 flex-1 leading-relaxed text-sm">
                          {card.description}
                        </p>
          ...
          <ScrollReveal distance={20} delay={0.3} className="mt-8 md:mt-10 text-center">
      ...
      {/* 3. Services / Four Pillars */}
      <section id="services-preview" className="relative py-10 lg:py-16 overflow-hidden" aria-labelledby="services-preview-title">
        <div className="absolute inset-0" aria-hidden="true" />
        ...
        <div className="section-container relative z-10">
          <ScrollReveal distance={30} className="text-center max-w-3xl mx-auto mb-8 md:mb-10">
            <motion.span
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
          ...
          <ScrollReveal distance={30} delay={0.1}>
            <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8 md:mb-10">
              {[
                ...
                <StaggerItem key={pillar.name} delay={index * 0.05}>
                  ...
                  >
                    <GlassCard variant="elevated" hover padding="lg" border="accent" className="h-full flex flex-col">
                      <div className={`w-10 h-10 rounded-2xl flex items-center justify-center mb-3 bg-accent-${pillar.color}/10`}>
                        <div className={`w-7 h-7 rounded-xl bg-accent-${pillar.color}/20 flex items-center justify-center`}>
                      ...
                      <p className="text-body text-text-secondary mb-3 text-sm leading-relaxed flex-1">
                        {pillar.desc}
                      </p>
          ...
          <ScrollReveal distance={20} delay={0.3} className="mt-6 md:mt-8 text-center">
      ...
      {/* 4. Projects / Work */}
      <section id="projects-preview" className="relative py-10 lg:py-16 overflow-hidden" aria-labelledby="projects-preview-title">
        <div className="absolute inset-0" aria-hidden="true" />
        <div className="section-container relative z-10">
          <ScrollReveal distance={30} className="text-center max-w-3xl mx-auto mb-8 md:mb-10">
            <motion.span
          ...
          <ScrollReveal distance={30} delay={0.1}>
            <StaggerContainer staggerDelay={0.1} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 md:mb-10">
      ...
      {/* 5. FAQ + Final CTA (merged) */}
      <section id="faq-cta" className="relative py-10 lg:py-20 overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <ScrollReveal distance={30} className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <motion.span
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            <h2 className="font-heading font-bold text-display-md lg:text-display-lg text-text-primary mb-4 gradient-text">
              Questions & Answers
            </h2>
            <p className="text-body-lg text-text-secondary">
              Common questions about ESP32, Arduino, IoT, and more.
            </p>
          </ScrollReveal>

          <ScrollReveal distance={30} delay={0.1}>
            <StaggerContainer staggerDelay={0.08} className="max-w-3xl mx-auto space-y-4 mb-10 md:mb-12">
              {featuredFAQs.map((faq, index) => {
                ...
                return (
                  <StaggerItem key={faq.id} delay={index * 0.05}>
                    ...
                    >
                      <div
                        className="p-5 rounded-2xl bg-bg-elevated/50 border border-border/30 hover:border-accent-gold/30 transition-all duration-300 cursor-pointer"
          ...
          <ScrollReveal distance={30} className="mt-10 md:mt-12">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="relative p-6 lg:p-12 rounded-3xl bg-gradient-to-br from-bg-elevated/50 to-bg-card/50 border border-accent-gold/20 backdrop-blur-xl shadow-glass"
            >
              <div className="absolute top-4 left-4 w-12 h-12 border-t-2 border-l-2 border-accent-gold/50 rounded-tl-2xl pointer-events-none" aria-hidden="true" />
              <div className="absolute top-4 right-4 w-12 h-12 border-t-2 border-r-2 border-accent-gold/50 rounded-tr-2xl pointer-events-none" aria-hidden="true" />
              <div className="absolute bottom-4 left-4 w-12 h-12 border-b-2 border-l-2 border-accent-gold/50 rounded-bl-2xl pointer-events-none" aria-hidden="true" />
              <div className="absolute bottom-4 right-4 w-12 h-12 border-b-2 border-r-2 border-accent-gold/50 rounded-br-2xl pointer-events-none" aria-hidden="true" />
              <motion.span
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent-gold/10 border border-accent-gold/20 text-accent-gold text-caption font-medium mb-5"
              >
                <span className="w-2 h-2 rounded-full bg-accent-gold" aria-hidden="true" />
                Ready to Build?
              </motion.span>
              <h2 className="font-heading font-bold text-display-md text-text-primary mb-5 gradient-text">
                Have an electronics idea?
              </h2>
              <p className="text-body-lg text-text-secondary mb-6 md:mb-8 max-w-xl mx-auto leading-relaxed">
              ...
              <motion.div
                ...
                className="pt-5 border-t border-border/30 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 text-text-muted"
              >
